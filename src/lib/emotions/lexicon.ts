...
export const EMOTION_LEXICON: Record<Emotion, LexiconEntry[]> = {
  ...
  jealousy: [
    ...
    { phrase: 'better than me', weight: 1.8 },
    { phrase: 'so much better', weight: 1.6 },
    { phrase: 'everyone is better', weight: 1.8 },
    { phrase: 'better than i am', weight: 1.8 },
    { phrase: 'wish i could be like', weight: 1.6 },
    { phrase: 'wish i was like', weight: 1.6 },
    { phrase: "why can't i be like", weight: 1.6 },
    { phrase: 'compared to them', weight: 1.4 },
    { phrase: 'compared to everyone', weight: 1.4 },
    { phrase: 'have it all', weight: 1.2 },
  ],
  anxiety: [
